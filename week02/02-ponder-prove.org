...
#+BEGIN_SRC elisp
(global-set-key (kbd "C-x v c") (lambda () (interactive) (save-buffer) (vc-next-action "VERBOSE") (vc-push)))
#+END_SRC

#+RESULTS:
| lambda | nil | (interactive) | (save-buffer) | (vc-next-action VERBOSE) | (vc-push) |
