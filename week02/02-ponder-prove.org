...
#+BEGIN_SRC elisp
(global-set-key (kbd "C-x v c") (lambda () (interactive) (save-buffer) (vc-next-action t) (sleep 20) (vc-push)))
#+END_SRC

#+RESULTS:
| lambda | nil | (interactive) | (save-buffer) | (vc-next-action t) | (sleep 20) | (vc-push) |
...
Cc: This <Hi>
Modified-by: Fraser LeFevre <mp3lefevre@gmail.com>
